...
class ApiRandomController extends Controller
{
    ...
    public function index()
    {
        ...
        if ($response->successful()) {
            ...
            $people = collect($data)->map(function ($item) {
                return new RandomPeople([
                    'id' => $item['id'],
                    'uid' => $item['uid'],
            ...
            return view('home', ['people' => $people, 'isStaticPage' => false]);
        } else {
            return view('home', ['people' => collect(), 'isStaticPage' => false]);
        }
    }
